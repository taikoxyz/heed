...
node -e "const j = require('../contracts/out/Heed.sol/Heed.json'); console.log('export const HEED_ABI =', JSON.stringify(j.abi, null, 2), 'as const;')" > core/src/contract/abi.ts
```
