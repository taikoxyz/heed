...
Full deployment record: [`deployments/mainnet.json`](./deployments/mainnet.json). Contract documentation: [`contracts/README.md`](./contracts/README.md). Protocol design: [`docs/heed-design.md`](./docs/heed-design.md).
